...
import { AddGovernmentSchemeForm } from "@/components/schemes/AddGovernmentSchemeForm";
...
const GovtHealthSchemes = () => {
  ...
  const handleAddScheme = async (newScheme: Omit<GovernmentScheme, "id">) => {
    try {
      setIsLoading(true);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <HeroSection
        ...
        description="Comprehensive information about healthcare initiatives and schemes by the Government of India"
        backgroundImage="https://images.unsplash.com/photo-1576091160399-112ba8d25d1d"
      />
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {showAddForm && (
          <AddGovernmentSchemeForm onSubmit={handleAddScheme} isLoading={isLoading} />
        )}
...
export default GovtHealthSchemes;
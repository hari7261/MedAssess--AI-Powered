...
import { DiabetesQuestionnaire } from "@/components/questionnaires/DiabetesQuestionnaire";
import { DiabetesReportCard } from "@/components/report/DiabetesReportCard";
...
const DiabetesAssessment = () => {
  ...
  return (
    <div className="container mx-auto py-8 px-4">
      <h1 className="text-3xl font-bold mb-6 text-medical-dark">Diabetes Risk Assessment</h1>
